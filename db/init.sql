...
-- create tables
USE coffee_shop;
CREATE TABLE IF NOT EXISTS coffee_machine (id int NOT NULL AUTO_INCREMENT, sku varchar(6) NOT NULL, product_type varchar(25) NOT NULL, water_line_compatible BOOLEAN NOT NULL, PRIMARY KEY (id));
